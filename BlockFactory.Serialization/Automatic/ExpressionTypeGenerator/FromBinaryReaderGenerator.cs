...
internal class FromBinaryReaderGenerator : IExpressionTypeGenerator
{
    private readonly SerializerBuilder _builder;

    internal FromBinaryReaderGenerator(SerializerBuilder builder)
    {
        _builder = builder;
    }
    ...
    public ParameterExpression[] GetParameters(Type t)
    {
        return new[]
        {
            ...
            Expression.Parameter(typeof(BinaryReader), "reader")
        };
